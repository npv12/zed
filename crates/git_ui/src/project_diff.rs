use crate::{
    ...
    staged_diff::StagedDiffHunkRenderer,
    unstaged_diff::UnstagedDiffHunkRenderer,
};
    ...
    pub fn set_diff_base(
        ...
        self.diff.update(cx, |diff, cx| {
            ...
            diff.editor().update(cx, |editor, cx| {
                let renderer: Option<Arc<dyn editor::DiffHunkRenderer>> = match &base {
                    DiffBase::Staged => Some(Arc::new(StagedDiffHunkRenderer)),
                    DiffBase::Index => Some(Arc::new(UnstagedDiffHunkRenderer)),
                    _ => Some(Arc::new(DefaultDiffHunkRenderer)),
                };
